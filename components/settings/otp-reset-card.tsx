...
export function OtpResetCard() {
  ...
  return (
    <section className="rounded-xl border border-rose-200 bg-rose-50 p-4 sm:p-6">
      ...
      <button
        className="mt-4 min-h-11 w-full rounded-md bg-rose-600 px-4 py-2 text-sm font-medium text-white disabled:opacity-50 sm:w-auto"
        type="button"
        onClick={handleReset}
        disabled={submitting}
      >
