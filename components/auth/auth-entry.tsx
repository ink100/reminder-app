...
export function AuthEntry({
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl items-center justify-center px-4 py-6 md:py-10 md:px-6">
        ...
        <section className="flex w-full flex-col gap-5 md:w-[45%]">
          ...
          >
            <button
              ...
              className={`flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg px-3 py-3 text-sm font-medium transition-colors ${
                method === "passkey"
