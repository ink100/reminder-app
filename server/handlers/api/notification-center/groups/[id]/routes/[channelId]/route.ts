...
export async function PUT(request: Request, context: { params: Promise<{ id: string; channelId: string }> }) {
...
export async function DELETE(_request: Request, context: { params: Promise<{ id: string; channelId: string }> }) {
